...
#SBATCH --job-name=task1        # Name of the job
...
#SBATCH --output=task1.out    # File to which STDOUT will be written
#SBATCH --error=task1.err     # File to which STDERR will be written
