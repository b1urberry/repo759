...
#SBATCH --job-name=task3        # Name of the job
...
#SBATCH --output=task3.out    # File to which STDOUT will be written
#SBATCH --error=task3.err     # File to which STDERR will be written
